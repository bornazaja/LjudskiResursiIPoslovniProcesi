...
import com.bzaja.myjavalibrary.util.LocalDatePattern;
...
public class TransakcijeZadaniPeriodPdfReport {
    ...
    private PdfPTable createTransakcijeTable(List<TransakcijaReportItemDto> transakcijaReportItems, ValutaDto valuta) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, transakcijaReportItems, PropertyInfoUtils.toPropertiesInfo(displayProperties, nameProperties), new ArrayList<>(), LanguageFormat.HR);
    }
    ...
    private PdfPTable createDetaljiIzracunaTable(TransakcijaResultListDto transakcijaResultListDto) {
        ...
        return PdfTableMaker.make(pdfTableSingleBeanConfiguration, transakcijaResultListDto, PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), LanguageFormat.HR);
    }
}
