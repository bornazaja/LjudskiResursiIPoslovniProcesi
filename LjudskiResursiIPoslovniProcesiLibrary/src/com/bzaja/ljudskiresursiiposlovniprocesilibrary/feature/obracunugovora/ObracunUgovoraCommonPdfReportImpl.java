...
import com.bzaja.myjavalibrary.pdf.PdfTableListBeanConfiguration;
...
public class ObracunUgovoraCommonPdfReportImpl implements ObracunUgovoraCommonPdfReport {
    ...
    public PdfPTable createPodaciOZaposlenikuTable(ZaposlenikBasicDetailsDto zaposlenikBasicDetailsDto) {
        ...
        return PdfTableMaker.make(pdfTableSingleBeanConfiguration, zaposlenikBasicDetailsDto, PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), LanguageFormat.HR);
    }
    ...
    public PdfPTable createDavanjaTable(DavanjeResultListDto davanjeResultList) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, davanjeResultList.getDavanjaDetailsDto(), PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), footerCells, LanguageFormat.HR);
    }
    ...
    public PdfPTable createDodatciTable(DodatakResultListDto dodatakResultList) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, dodatakResultList.getDodatciDetailsDto(), PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), footerCells, LanguageFormat.HR);
    }
    ...
    public PdfPTable createObustaveTable(ObustavaResultListDto obustavaResultList) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, obustavaResultList.getObustaveDetailsDto(), PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), footerCells, LanguageFormat.HR);
    }
    ...
    public PdfPTable createPrekovremeniRadoviTable(PrekovremeniRadResultListDto prekovremeniRadResultList) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, prekovremeniRadResultList.getPrekovremeniRadoviDetailsDto(), PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), footerCells, LanguageFormat.HR);
    }
}
