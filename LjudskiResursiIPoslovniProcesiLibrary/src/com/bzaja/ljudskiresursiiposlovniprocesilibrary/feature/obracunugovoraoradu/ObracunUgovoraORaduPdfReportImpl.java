...
public class ObracunUgovoraORaduPdfReportImpl implements ObracunUgovoraORaduPdfReport {
    ...
    private PdfPTable createPodaciOUgovoruTable(UgovorORaduDetailsDto ugovorORaduDetailsDto) {
        ...
        return PdfTableMaker.make(pdfTableSingleBeanConfiguration, ugovorORaduDetailsDto, PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), LanguageFormat.HR);
    }
    ...
    private PdfPTable createPodaciOObracunuTable(ObracunUgovoraORaduResultDto obracunUgovoraORaduResultDto) {
        ...
        return PdfTableMaker.make(pdfTableSingleBeanConfiguration, obracunUgovoraORaduResultDto, PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), LanguageFormat.HR);
    }
    ...
    private PdfPTable createOlaksiceTable(OlaksicaResultListDto olaksicaResultList) {
        ...
        return PdfTableMaker.make(pdfTableListBeanConfiguration, olaksicaResultList.getOlaksiceDetailsDto(), PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), footerCells, LanguageFormat.HR);
    }
    ...
    private PdfPTable createDetaljiIzracunaTable(IsplatnaListaUgovoraORaduDto isplatnaListaUgovoraORaduDto) {
        ...
        return PdfTableMaker.make(pdfTableSingleBeanConfiguration, isplatnaListaUgovoraORaduDto, PropertyInfoUtils.toPropertiesInfo(displayNames, propertyNames), LanguageFormat.HR);
    }
}
