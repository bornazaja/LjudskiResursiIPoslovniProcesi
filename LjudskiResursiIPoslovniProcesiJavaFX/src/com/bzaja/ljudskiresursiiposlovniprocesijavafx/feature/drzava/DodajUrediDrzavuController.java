...
public class DodajUrediDrzavuController implements Initializable, ControllerInterface<DrzavaDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(valuteSearchableComboBox, text -> valutaService.findAll(text, "naziv"), "idValuta", "naziv", "Desila se greška prilikom dohvaćanja valuta.", LanguageFormat.HR);
        clearErrorLabels();
    }
