...
public class DodajUrediPoslovnogPartneraController implements Initializable, ControllerInterface<PoslovniPartnerDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(gradoviSearchableComboBox, text -> gradService.findAll(text, "naziv"), "idGrad", "naziv", "Desila se greška prilikom dohvaćanja gradova.", LanguageFormat.HR);
        clearErrorLabels();
    }
