...
public class DodajObracunUgovoraODjeluController implements Initializable {
    ...
    private void fetchData() {
        try {
            ControlUtils.fillComboBox(vrsteObracunaComboBox, vrstaObracunaService.findAll(), "idVrstaObracuna", "naziv", 0, false, LanguageFormat.HR);
            ...
            ControlUtils.setupSearchableListSelectionView(ugovoriODjeluSearchableListSelectionView, text -> ugovorODjeluService.findAllNeObraucunateUgovore(text, "zaposlenik.prezime", "zaposlenik.oib"), "idUgovor", "zaposlenik.prezime+zaposlenik.oib", "Desila se greška prilikom dohvačanja ugovora o djelu.", LanguageFormat.HR);
        } catch (Exception e) {
