...
public class DodajUrediOlaksicuZaposlenikaController implements Initializable, ControllerInterface<OlaksicaDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(olaksiceSearchableComboBox, text -> vrstaOlaksiceService.findAll(text, "naziv"), "idVrstaOlaksice", "naziv", "Desila se greška prilikom dohvaćanja vrsta olakšica.", LanguageFormat.HR);
        clearErrorLabels();
    }
