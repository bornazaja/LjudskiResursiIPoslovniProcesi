...
public class DodajUrediPorezController implements Initializable, ControllerInterface<PorezDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(vrstePorezaSearchableComboBox, text -> vrstaPorezaService.findAll(text, "naziv"), "idVrstaPoreza", "naziv", "Desila se greška prilikom dohvaćanja vrste poreza.", LanguageFormat.HR);
        ControlUtils.setupSearchableComboBox(drzaveSearchableComboBox, text -> drzavaService.findAll(text, "naziv"), "idDrzava", "naziv", "Desila se greška prilikom dohvaćanja država.", LanguageFormat.HR);
        clearErrorLabels();
    }
