...
public class DodajUrediTransakcijuController implements Initializable, ControllerInterface<TransakcijaDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(poslovniPartneriSearchableComboBox, text -> poslovniPartnerService.findAll(text, "naziv"), "idPoslovniPartner", "naziv", "Desila se greška prilikom dohvaćanja poslovnih partnera.", LanguageFormat.HR);
        ControlUtils.setupSearchableComboBox(valuteSearchableComboBox, text -> valutaService.findAll(text, "naziv"), "idValuta", "naziv+srednjiTecaj", "Desila se greška prilikom dohvaćanja valuta.", LanguageFormat.HR);
        ControlUtils.setupSearchableComboBox(vrsteTransackijaSearchableComboBox, text -> vrstaTransakcijeService.findAll(text, "naziv"), "idVrstaTransakcije", "naziv", "Desila se greška prilikom dohvaćanja vrsta transakcija.", LanguageFormat.HR);
        ControlUtils.setupSearchableComboBox(kategorijeTransakcijaSearchableComboBox, text -> kategorijaTransakcijeService.findAll(text, "naziv"), "idKategorijaTransakcije", "naziv", "Desila se greška prilikom dohvačanja kategorija transakcija.", LanguageFormat.HR);
        clearErrorLabels();
    }
