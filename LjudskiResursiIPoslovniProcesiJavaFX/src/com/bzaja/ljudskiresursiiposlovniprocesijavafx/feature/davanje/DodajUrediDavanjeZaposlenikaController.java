...
public class DodajUrediDavanjeZaposlenikaController implements Initializable, ControllerInterface<DavanjeDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(vrstaDavanjaSearchableTableView, text -> vrstaDavanjaService.findAll(text, "naziv"), "idVrstaDavanja", "naziv", "Desila se greška prilikom dohvaćanja vrsta davanja.", LanguageFormat.HR);
        clearErrorLabels();
    }
