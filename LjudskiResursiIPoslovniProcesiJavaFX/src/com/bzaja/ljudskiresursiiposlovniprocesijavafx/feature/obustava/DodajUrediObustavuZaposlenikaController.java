...
public class DodajUrediObustavuZaposlenikaController implements Initializable, ControllerInterface<ObustavaDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(vrsteObustaveSearchabeComboBox, text -> vrstaObustaveService.findAll(text, "naziv"), "idVrstaObustave", "naziv", "Desila se greška prilikom dohvaćanja vrsta obustava.", LanguageFormat.HR);
        clearErrorLabels();
    }
    ...
    private void setupValuta(ObustavaDto t) {
        ...
        }, "Desila se greška prilikom dohvačanja valute.");
    }
