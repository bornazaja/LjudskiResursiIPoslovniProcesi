...
import com.bzaja.myjavafxlibrary.util.MenuBarBuilder;
import com.bzaja.myjavafxlibrary.util.MenuBarResultDto;
...
public class GlavniIzbornikController implements Initializable, ControllerInterface<PrijavljeniZaposlenikDto> {
    ...
    private MenuBarResultDto createAdministatorMenu() {
        return new MenuBarBuilder(0)
                ...
                .addMenu("Tvrtka")
                .addMenuItem("Podaci o tvrtki", () -> stageManager.showSecondaryStage(FxmlView.PODACI_O_TVRTKI, AppUtils.getCssPathables()))
                ...
                .addMenuItem("Parametri za obračun plaće", () -> stageManager.showSecondaryStage(FxmlView.PARAMETRI_ZA_OBRACUN_PLACE, AppUtils.getCssPathables()))
                .addMenu("Zaposlenici")
    ...
    public void doLogout() {
        ...
        stageManager.showPrimaryStage(NodeUtils.getStageFromNode(contentPane), FxmlView.PRIJAVA, AppUtils.getCssPathables());
    }
}
