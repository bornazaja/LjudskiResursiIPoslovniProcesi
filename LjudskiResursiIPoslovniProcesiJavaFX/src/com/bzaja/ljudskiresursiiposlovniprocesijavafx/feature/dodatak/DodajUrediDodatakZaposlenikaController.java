...
public class DodajUrediDodatakZaposlenikaController implements Initializable, ControllerInterface<DodatakDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(vrsteDodatakaSearchableComboBox, text -> vrstaDodatkaService.findAll(text, "naziv"), "idVrstaDodatka", "naziv", "Desila se greška prilikom dohvaćanja vrsta dodataka.", LanguageFormat.HR);
        clearErrorLabels();
    }
