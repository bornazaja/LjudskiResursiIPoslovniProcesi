...
public class DodajUrediPrekovremeniRadZaposlenikaController implements Initializable, ControllerInterface<PrekovremeniRadDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(vrstePrekovremenihRadovaSearchableComboBox, text -> vrstaPrekovremenogRadaService.findAll(text, "naziv"), "idVrstaPrekovremenogRada", "naziv", "Desila se greška prilikom dohvaćanja vrste prekovremenih radova.", LanguageFormat.HR);
        clearErrorLabels();
    }
