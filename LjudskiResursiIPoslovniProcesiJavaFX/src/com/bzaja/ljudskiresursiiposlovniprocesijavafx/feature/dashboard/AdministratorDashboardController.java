...
public class AdministratorDashboardController implements Initializable, ControllerInterface<ZaposlenikDetailsDto> {
    ...
    private void initPovijestPrijavaTableView() {
        TableUtils.setupPropertyColumn(idPovijestPrijavaTableColumn, "idPovijestPrijava", LanguageFormat.HR);
        TableUtils.setupPropertyColumn(vrijemePrijaveTableColumn, "vrijemePrijave", LanguageFormat.HR);
        TableUtils.setupPropertyColumn(zaposlenikTableColumn, "zaposlenik.ime+zaposlenik.prezime", LanguageFormat.HR);
        TableUtils.setupPropertyColumn(rolaTableColumn, "rola.naziv", LanguageFormat.HR);
    }
