...
public class UrediZaposlenikaController implements Initializable, ControllerInterface<EditZaposlenikDto> {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(spoloviSearchableComboBox, text -> spolService.findAll(text, "naziv"), "idSpol", "naziv", "Desila se greška prilikom dohvaćabja spolova.", LanguageFormat.HR);
        clearErrorLabels();
    }
