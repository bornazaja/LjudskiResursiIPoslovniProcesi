...
public class DodajZaposlenikaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ControlUtils.setupSearchableComboBox(spoloviSearchableComboBox, text -> spolService.findAll(text, "naziv"), "idSpol", "naziv", "Desila se greška prilikom dohvaćanja spolova.", LanguageFormat.HR);
        clearErrorLabels();
    }
